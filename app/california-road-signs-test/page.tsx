/**
 * SEO Landing Page: /california-road-signs-test
 *
 * Primary keyword:   "california road signs test"
 * Secondary:         "california road signs quiz", "california traffic signs",
 *                    "ca dmv road signs 2026", "california permit test road signs"
 *
...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "what does this road sign mean california",
    "california permit test road signs",
    "ca dmv road signs 2026",
  ],
  alternates: {
    canonical: "https://aceyourpermit.com/california-road-signs-test",
  },
  openGraph: {
    title: "California Road Signs Test — Study Guide 2026",
    description:
...
const canonicalUrl = "https://aceyourpermit.com/california-road-signs-test";

const faqItems = [
  {
    question: "How many road sign questions are on the California DMV test?",
    answer:
      "The California DMV knowledge test has 46 total questions. Approximately 12–18 cover traffic signs and signals — making signs the single largest tested category.",
  },
  {
  ...
  {
    question: "What color is a warning sign in California?",
    answer:
  ...
  {
    question: "What does an orange diamond sign mean in California?",
    answer:
      "Orange diamond signs mark construction or work zones. They indicate temporary traffic changes such as lane shifts, reduced speed limits, or road work ahead. Fines are increased in California construction zones.",
  },
  {
    question: "Are California road signs different from other states?",
    answer:
      "Most signs follow the federal MUTCD standard, so they are the same nationwide. California uses specific supplemental signs for the freeway system, Caltrans highway designations, and some route markers that differ from other states.",
  },
  {
    question: "How do I memorize road signs fast for the CA DMV test?",
    answer:
      "Group signs by SHAPE first (octagon = STOP, inverted triangle = YIELD, diamond = warning), then by COLOR (red = stop/prohibit, yellow = warning, orange = construction, green = guide, blue = services). Shape alone can often tell you what to do even if you cannot read the text from a distance.",
  },
];
  ...
  "@graph": [
    {
      ...
      url: canonicalUrl,
      name: "California Road Signs Test — Study Guide 2026",
      description:
        "Complete visual study guide for every California road sign category with free practice quiz.",
      inLanguage: "en-US",
    },
    {
      "@type": "FAQPage",
...
const regulatorySigns: SignCard[] = [
  {
    ...
    textColor: "#ffffff",
    symbol: "STOP",
    meaning: "Come to a complete stop at the limit line, crosswalk, or before the intersection.",
    rule: "You must make a full stop — not just slow down. Proceed when safe.",
  },
  {
    id: "ca-sign-yield",
    name: "YIELD",
  ...
  },
  {
    ...
    rule: "Typically posted at freeway off-ramps and one-way street entrances. Never enter.",
  },
  {
    id: "ca-sign-speed-limit",
    name: "SPEED LIMIT",
    shape: "rectangle",
    ...
    textColor: "#000000",
    symbol: "65",
    meaning: "Maximum legal speed under ideal conditions. CA residential default: 25 mph.",
    rule: "You must not exceed the posted number. Drive slower when conditions are poor.",
  },
  {
    id: "ca-sign-no-u-turn",
    name: "NO U-TURN",
    shape: "rectangle",
    ...
    rule: "California prohibits U-turns at intersections with posted signs and in business districts.",
  },
  {
    id: "ca-sign-wrong-way",
    name: "WRONG WAY",
    shape: "rectangle",
...
const warningSigns: SignCard[] = [
  ...
  },
  {
    ...
    rule: "California speed limit is 25 mph in school zones when children are present.",
  },
  {
    id: "ca-sign-railroad",
  ...
  },
  {
    ...
    rule: "California law requires drivers to stop for pedestrians in marked and unmarked crosswalks.",
  },
  {
    id: "ca-sign-merge",
    name: "MERGE",
...
const constructionSigns: SignCard[] = [
  {
    ...
    rule: "California increases fines for moving violations in active construction zones.",
  },
  {
    id: "ca-sign-flagger",
    name: "FLAGGER AHEAD",
    ...
    rule: "Obey flagger instructions the same way you obey traffic signals.",
  },
  {
    id: "ca-sign-lane-ends",
    name: "LANE ENDS",
    shape: "diamond",
    shapeDesc: "Orange diamond",
    color: "Orange / Black",
...
const guideSigns: SignCard[] = [
  {
    ...
    rule: "California Interstates follow federal numbering: I-80 runs east-west; I-5 north-south.",
  },
  {
    id: "ca-sign-destination",
    ...
    rule: "Overhead green signs on freeways indicate lane assignments — get in the correct lane early.",
  },
  {
    id: "ca-sign-services",
    ...
    textColor: "#ffffff",
    symbol: "⛽",
    meaning: "Motorist services are available at this exit.",
    rule: "Blue service signs list specific brand names at the next exit for easy identification.",
  },
  {
    id: "ca-sign-state-route",
    name: "CA STATE ROUTE",
    shape: "shield",
    shapeDesc: "Spade-shaped California state route marker",
    color: "Yellow / Black",
    colorHex: "#EAB308",
    borderColor: "#000000",
    textColor: "#000000",
    symbol: "◇",
    meaning: "Identifies a California state highway.",
    rule: "California state routes use a distinctive spade shape. Three-digit routes are typically urban.",
  },
];

// ---------------------------------------------------------------------------
// Sample questions
// NOTE: General road signs knowledge consistent with CA DMV handbook.
// ---------------------------------------------------------------------------
...
const sampleQuestions: SampleQuestion[] = [
  {
    ...
    correct_answer: 0,
    explanation:
      "A red octagonal (8-sided) sign is the universal STOP sign. You must come to a complete stop at the limit line or before entering the crosswalk or intersection.",
  },
  {
    id: "ca-ts-004",
  ...
  {
    id: "ca-ts-010",
    question_text: "What color are warning signs in California?",
    options: [
    ...
    correct_answer: 0,
    explanation:
      "Warning signs are yellow with black letters or symbols. They alert you to possible hazards ahead and are diamond-shaped.",
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="w-full text-left border-t border-slate-100 pt-3 mt-1">
        ...
        <p className="text-xs font-semibold text-orange-600 mt-2 mb-1">California Rule</p>
...
export default function CaliforniaRoadSignsTestPage() {
  return (
    <>
      <script
      ...
      <div className="force-light min-h-screen bg-gradient-to-b from-orange-50 to-white">
        {/* Nav */}
        ...
        <section className="pt-14 pb-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-100 text-orange-700 text-sm font-medium mb-6">
              ...
              Updated for California DMV test 2026
            </div>
            ...
            <p className="text-xl text-slate-600 mb-4 max-w-3xl mx-auto">
              Every sign on the California DMV permit test — visual descriptions, shapes, colors, and
              exact meanings. Study regulatory, warning, guide, and construction signs, then quiz yourself for free.
            </p>
            <p className="text-base text-slate-500 mb-8 max-w-2xl mx-auto">
              Signs make up approximately 12–18 of the 46 questions on the CA DMV written test.
        ...
        <section className="py-8 px-4 bg-white border-y border-slate-100">
          <div className="max-w-5xl mx-auto grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
            {[
              { label: "Sign questions on the CA test", value: "~15" },
              { label: "Sign categories tested", value: "4" },
              { label: "Total test questions", value: "46" },
              { label: "Passing score needed", value: "83%" },
            ].map((stat) => (
              <div key={stat.label}>
        ...
        <section className="py-14 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-slate-600 mb-8">
              California road signs use standardized shapes and colors. Learn these two dimensions and
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-slate-600">
                ...
                They carry the force of California law — ignoring them is a traffic violation.
              </p>
            </div>
        ...
        <section className="py-14 px-4 sm:px-6 lg:px-8 bg-orange-50/40">
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-slate-600">
                Orange diamond signs mark <strong>temporary construction zones</strong>. California
          ...
          <div className="max-w-5xl mx-auto">
            <div className="mb-8">
              ...
              <p className="text-slate-600">
                ...
                route and destination information; blue signs point to motorist services.
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          <div className="max-w-3xl mx-auto">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold text-slate-900 font-display tracking-tight mb-3">
                Sample California Road Sign Questions
              </h2>
              <p className="text-slate-600">
                Real-format questions from our California permit test question bank.
              </p>
            </div>
        ...
        <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-600 to-blue-800">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-blue-200 text-sm mt-4">
              All questions free. California DMV test topics only.
            </p>
          </div>
        </section>
      </div>
